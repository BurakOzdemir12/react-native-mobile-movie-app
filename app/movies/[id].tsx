...
const MovieInfo = ({label, value}: MovieInfoProps) => (
    <View className="flex-col items-start justify-cennter mt-5 ">
    ...
    return (
        <View className="bg-primary flex-1">
            <ScrollView contentContainerStyle={{
                ...
                <View className="flex-col items-start justify-cennter mt-5 px-5">
                    ...
                    <MovieInfo label="Production Companies" value={movie?.production_companies.map((c) =>
                        c.name).join(' - ') ?? "N/A"}/>
                </View>
            </ScrollView>
            <TouchableOpacity
